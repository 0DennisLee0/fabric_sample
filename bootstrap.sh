...
# pullBinaries() {
    ...
    # download "${BINARY_FILE}" "https://github.com/0DennisLee0/fabric/releases/v${VERSION}/${BINARY_FILE}"
    # if [ $? -eq 22 ]; then
        # echo
    ...
    # download "${CA_BINARY_FILE}" "https://github.com/0DennisLee0/fabric-ca/releases/download/v${CA_VERSION}/${CA_BINARY_FILE}"
    # if [ $? -eq 22 ]; then
        # echo
